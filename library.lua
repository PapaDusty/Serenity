...
local Library do
	...
	local CustomFont = {} do
		function CustomFont:New(Name, Weight, Style, Data)
			...
			writefile(string.format("%s/%s.font", Library.Folders.Fonts, Name), HttpService:JSONEncode(Data))
			return Font.new(getcustomasset(string.format("%s/%s.font", Library.Folders.Fonts, Name)), Enum.FontWeight.Regular, Enum.FontStyle.Normal)
		end
	...
	do
		...
		Library.Notification = function(self, Name, Duration, Icon)
			...
			Library:Thread(function()
				for Index, Value in pairs(Items) do
					if Value.Instance:IsA("Frame") then
						Value:Tween(nil, {BackgroundTransparency = 0.2})
					elseif Value.Instance:IsA("TextLabel") then
	...
	local AimbotSection = CombatPage:Section({Name = "Aimbot", Icon = "136879043989014", Side = 1})
	local AimbotSection2 = CombatPage:Section({Name = "Aimbot", Icon = "136879043989014", Side = 2})
