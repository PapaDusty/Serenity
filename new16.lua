-- Enhanced Roblox UI Library v3.1 (Loadstring Compatible)
...
-- Load Lucide Icons safely
local Icons = {}
pcall(function()
	Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nebula-Softworks/Nebula-Icon-Library/master/LucideIcons.luau"))()
end)
...
function Library:CreateWindow(config)
	...
	local tabContainer = Create("Frame", {
		Parent = main,
		Position = UDim2.new(0.019, 0, 0.115, 0),
		Size = UDim2.new(0, 135, 0, 340),
		BackgroundTransparency = 1
	})
	...
	local contentScroll = Create("ScrollingFrame", {
		Parent = main,
		Position = UDim2.new(0.237, 0, 0.115, 0),
		Size = UDim2.new(0.763, 0, 0.885, 0),
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
			...
			for _, elem in ipairs(Tab.Elements) do
				...
				elseif elem.Type == "Button" then
					...
					if elem.Description ~= "" then
						Create("TextLabel", {
							Parent = frame,
							AnchorPoint = Vector2.new(0, 0.5),
							Position = UDim2.new(0.026, 0, 0.5, 12),
				...
				elseif elem.Type == "Slider" then
					...
					local valueLabel = Create("TextLabel", {
						Parent = frame,
						AnchorPoint = Vector2.new(1, 0.5),
						Position = UDim2.new(0.974, -90, 0.5, 0),
				...
				elseif elem.Type == "Dropdown" then
					...
					-- Overlay dropdown menu (FIXED - uses GUI root)
					local dropdownMenu = Create("ScrollingFrame", {
						Parent = gui, -- Use GUI root
						Position = UDim2.new(0, 0, 0, 0),
						Size = UDim2.new(0, dropdownBtn.AbsoluteSize.X, 0, math.min(#elem.Values * 26, 150)),
						BackgroundColor3 = Color3.fromRGB(20, 20, 20),
						BorderSizePixel = 0,
				...
				elseif elem.Type == "Colorpicker" then
					...
					Create(create, "UIStroke", {Color = Color3.fromRGB(45, 45, 45), Thickness = 1, Parent = colorPreview})
					...
					colorPreview.MouseButton1Click:Connect(function()
						...
						Create("UICorner", {CornerRadius = UDim.new(0.02, 0), Parent = colorDialog})
						Create("UIStroke", {Color = Color3.fromRGB(45, 45, 45), Thickness = 1, Parent = colorDialog})
						...
						closeBtn.MouseButton1Click:Connect(function() colorDialog:Destroy() elem.Open = false end)
						...
						local r = math.floor(elem.Value.R * 255)
						local g = math.floor(elem.Value.G * 255)
						local b = math.floor(elem.Value.B * 255)
						...
						redInput.FocusLost:Connect(function()
							r = math.clamp(tonumber(redInput.Text) or 0, 0, 255)
							updateColor()
						...
						local greenInput = Create("TextBox", {
							Parent = greenSlider,
							Size = UDim2.new(1, -30, 1, 0),
							Position = UDim2.new(0, 25, 0, 0),
							BackgroundColor3 = Color3.fromRGB(40, 40, 40),
						...
						greenInput.FocusLost:Connect(function()
							g = math.clamp(tonumber(greenInput.Text) or 0, 0, 255)
							updateColor()
						...
						local blueInput = Create("TextBox", {
							Parent = blueSlider,
							Size = UDim2.new(1, -30, 1, 0),
							Position = UDim2.new(0, 25, 0, 0),
							BackgroundColor3 = Color3.fromRGB(40, 40, 40),
						...
						blueInput.FocusLost:Connect(function()
							b = math.clamp(tonumber(blueInput.Text) or 0, 0, 255)
							updateColor()
