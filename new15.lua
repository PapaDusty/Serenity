...
function Library:CreateWindow(config)
	...
	local tabContainer = Create("Frame", {
		Parent = main,
		Position = UDim2.new(0.019, 0, 0.115, 0), -- Moved up
		Size = UDim2.new(0, 135, 0, 340), -- LONGER
		BackgroundTransparency = 1
	})
		...
		function Tab:Render()
			...
			for _, elem in ipairs(Tab.Elements) do
				...
				elseif elem.Type == "Button" then
					-- TALLER BUTTONS (48px instead of 42)
					local frame = Create("Frame", {
						Parent = container,
				...
				elseif elem.Type == "Slider" then
					...
					local valueLabel = Create("TextLabel", {
						Parent = frame,
						AnchorPoint = Vector2.new(1, 0.5),
						Position = UDim2.new(0.974, -90, 0.5, 0), -- Moved left
						...
						TextColor3 = Color3.fromRGB(150, 150, 150),
						TextSize = 14,
						TextXAlignment = Enum.TextX.Alignment.Right
					})
				...
				elseif elem.Type == "Dropdown" then
					...
					local dropdownMenu = Create("ScrollingFrame", {
						Parent = gui, -- Use GUI root instead of frame
