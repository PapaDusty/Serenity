-- Enhanced Roblox UI Library (Fully Fixed Version)
...
function Library:CreateWindow(config)
	...
	if Window.CanMinimize then
		createButton("rbxassetid://104255241083015", UDim2.new(0, 18, 0, 18), UDim2.new(0, 20, 0, 2), function()
	...
	if Window.CanClose then
		createButton("rbxassetid://114783304987099", UDim2.new(0, 18, 0, 18), UDim2.new(0, 42, 0, 2), function()
			Window:Destroy()
		end)
	end
	...
	function Window:CreateTab(name)
		...
		function Tab:AddParagraph(config)
			...
			local elem = {
				...
				Visible = true,
				Side = 0 -- Ensure Side property exists
			}
		...
		function Tab:Render()
			...
			for _, elem in ipairs(Tab.Elements) do
				...
				elseif elem.Type == "Button" then
					local frame = Create("Frame", {
						Parent = container,
						Size = UDim2.new(elem.Side == 1 and 0.5 or 1, elem.Side == 1 and -3 or 0, 0, 42),
						BackgroundColor3 = Color3.fromRGB(25, 25, 25),
						BorderSizePixel = 0,
				...
				elseif elem.Type == "Colorpicker" then
					local frame = Create("Frame", {
						Parent = container,
						Size = UDim2.new(elem.Side == 1 and 0.5 or 1, elem.Side == 1 and -3 or 0, 0, elem.Open and (elem.Transparency and 120 or 100) or 42),
						BackgroundColor3 = Color3.fromRGB(25, 25, 25),
						BorderSizePixel = 0
					})
					Create("UICorner", {CornerRadius = UDim.new(0.1, 0), Parent = frame})
...
-- Save Manager (Fixed but optional)
Library.SaveManager = {
	Library = nil,
